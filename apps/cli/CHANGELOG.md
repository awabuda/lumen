...
- 30d15ac: P63 — `lumen chat` now defaults to the OpenClaw-style
...
- 26d3e8a: P62 — `~/.lumen/MEMORY.md` + `USER.md` are now
...
- e347bc5: P61 — `lumen chat` TUI restoration now respects
...
- 1d31fc9: P59 — `lumen chat` now falls back to the most
...
- 34b21f3: P57 — when the TUI mounts and the P32.2
...
- fe8e8ce: P56 — `lumen memory show` now reflects the
