...
- [ ] **P18.3** — Concurrent agent runs / load test. Out of P17 scope; needs coordinated cancellation, per-tenant rate-limit accounting, and a more sophisticated harness. Worthwhile once the perf baseline from P17.3 + P18.2 is captured.
