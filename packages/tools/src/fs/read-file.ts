...
export class ReadFileTool extends BaseTool {
  ...
  public readonly description =
    'Read a text file. Returns content with line numbers (e.g. "   42|code") and the total line count. ' +
    'Use offset+limit to page through large files. Resolves relative paths against the working directory.'
  public readonly inputSchema: z.ZodType<unknown> = ReadFileInputSchema
