 ...
 */
export async function atomicWriteFile(absPath, content, signal) {
...
export class WriteFileTool extends BaseTool {
    name = 'write_file';
    description = 'Write text content to a file. By default, writes atomically (writes to a .tmp file then renames) ' +
    ...
    async execute(input, ctx) {
        const { path: userPath, content, atomic } = input;
